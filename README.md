...
Реалните портрети и акредитационни изображения са свалени локално в `public/images`, а hero изображението е генерирано и записано в `src/assets/baimp-hero.png`.
